...
//     console.log({ name, email, message, authorized });
//     // Reset form fields
//     setName('');
//     setEmail('');
//     setMessage('');
...
//   return (
//     <div className="relative flex items-center justify-center min-h-screen w-full bg-sky-950 z-[200]">
...
//       {/* Form Container */}
//       <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-lg p-10 rounded-xl shadow-xl w-1/2 space-y-6 absolute right-20 transform transition duration-500 hover:scale-105">
...
const CallbackForm = () => {
  ...
  return (
    <div id='callback' className="relative flex items-center justify-center min-h-screen w-full bg-sky-950 z-[200]">
      ...
      <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-lg p-10 rounded-xl shadow-xl w-1/3 space-y-4 absolute right-20 transform transition duration-500 hover:scale-105">
        <h2 className="text-4xl text-white text-center font-semibold">Get In Touch</h2>
        <div>
          <label className="block text-white text-lg mb-2">Name</label>
          <input
