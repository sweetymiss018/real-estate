...
// function FloorPlan() {
//   return (
//     <div id='floorplan' className="min-h-screen bg-red-50 px-8 py-12">
//       {/* Title */}
//       <h1 className="text-7xl text-[#BC9170] font-serif font-semibold  mb-20">Floor Plan</h1>
...
function FloorPlan() {
  return (
    <div id='floorplan' className="min-h-screen bg-red-50 px-8 py-12 relative">
      {/* Title */}
      <h1 className="text-7xl text-[#BC9170] font-serif font-semibold mb-20">Floor Plan</h1>
