...
//       {/* Heading */}
//       <div className="absolute z-[100] text-6xl top-[-4.5vw] font-bold font-serif text-[#FDD09E]">
//         <h1>Luxury</h1>
//         <h1>LifeStyle</h1>
//       </div>
...
//           <div className="mb-1 font-serif text-responsive text-left">
//             {propertyListings[activeIndex].title}
//           </div>
//           {propertyListings[activeIndex].description.map((text, idx) => (
//             <p key={idx} className="mb-1 text-xl text-left">
//               {text}
//             </p>
//           ))}
//         </div>
...
//       <div className="absolute bottom-4 left-1/2 gap-32 transform -translate-x-1/2 flex items-center space-x-2 z-20">
//         {/* Line connecting the navigation buttons */}
//         <div className="absolute w-[95%] ml-2  h-1 bg-white top-1/2 -translate-y-1/2 z-10"></div>
...
//               activeIndex === index ? 'ring-2 ring-white scale-[2]' : ''
//             } z-20`}
//           >
//             <img
...
export default function Luxury() {
  ...
  return (
    <div id='lifestyle' className="relative min-h-screen w-full overflow-hidden ">
      ...
      {/* Image Navigation Buttons */}
      <div className="absolute bottom-[2.8vw] left-1/2 gap-32 transform -translate-x-1/2 flex items-center space-x-4 z-0">
      {/* Line connecting the navigation buttons */}
        <div className="absolute w-[95%] ml-[1.2vw]  h-1 bg-white top-1/2 -translate-y-1/2 z-100 "></div>
        {propertyListings.map((_, index) => (
          <button
            key={index}
            onClick={() => {
            ...
            className={`relative w-20 h-20 rounded-full overflow-hidden border-2 border-white ${
              activeIndex === index ? 'ring-2 ring-white scale-[2]' : ''
            } z-100`}
          >
            <img
