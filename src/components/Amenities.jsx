...
//   return (
//     <div id="amenities" className="bg-red-50 min-h-screen  flex justify-start items-end px-8  relative z-[100]">
//       {/* Rotated Heading */}
//       <div className="w-1/3 flex justify-start h-full pb-[10vw] items-start">
//         <h1 className="text-sky-950 rotate-[-90deg] text-7xl font-serif font-bold">
//           Amenities <br /> & <br /> Facilities
//         </h1>
//       </div>

//       {/* Image Slider Section */}
//       <div className="relative w-2/3 flex overflow-hidden">
//         <div
...
//                 src={image.src}
//                 alt={image.text}
//                 className="w-full h-1200 object-cover rounded-lg transition-transform duration-500 hover:scale-110 shadow-inner hover:shadow-[inset_0_0_40px_10px_rgba(3,37,76,0.7)]"
//               />
...
//                 <div className="text-white text-3xl font-serif p-4 text-center">
...
//           className={`absolute left-0 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-gray-800 to-gray-600 text-white p-6 rounded-full hover:scale-110 transition-all duration-300 shadow-xl ${
...
//         <button
//           onClick={goToNext}
//           className={`absolute right-0 top-1/2 transform -translate-y-1/2 bg-gradient-to-l from-gray-800 to-gray-600 text-white p-6 rounded-full hover:scale-110 transition-all duration-300 shadow-xl ${
//             currentIndex === images.length - 2 ? "opacity-50 cursor-not-allowed" : ""
//           }`}
...
//   return (
//     <div id="amenities" className="bg-red-50 min-h-screen flex flex-col md:flex-row justify-start items-end px-4 md:px-8 relative z-[100]">
//       {/* Rotated Heading */}
//       <div className="w-full md:w-1/3 flex justify-center md:justify-start h-full pb-8 md:pb-[10vw] items-start">
//         <h1 className="text-sky-950 text-4xl md:text-5xl font-serif font-bold ">
//           Amenities <br /> & <br /> Facilities
//         </h1>
//       </div>
...
//         <button
//           onClick={goToPrevious}
//           className={`absolute left-0 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-gray-800 to-gray-600 text-white p-3 md:p-6 rounded-full hover:scale-110 transition-all duration-300 shadow-xl ${
//             currentIndex === 0 ? "opacity-50 cursor-not-allowed" : ""
//           }`}
//           disabled={currentIndex === 0}
//         >
...
//         <button
//           onClick={goToNext}
//           className={`absolute right-0 top-1/2 transform -translate-y-1/2 bg-gradient-to-l from-gray-800 to-gray-600 text-white p-3 md:p-6 rounded-full hover:scale-110 transition-all duration-300 shadow-xl ${
//             currentIndex === images.length - 2 ? "opacity-50 cursor-not-allowed" : ""
//           }`}
//           disabled={currentIndex === images.length - 2}
//         >
...
export default function Amenities() {
  ...
  return (
    <div id="amenities" className="bg-red-50 min-h-screen flex flex-col md:flex-row justify-start items-start py-8 px-4 md:px-8 relative z-[100]">
      {/* Heading with Icons */}
